...
Defines the shared seed dataset used by local development, integration tests, and Playwright, plus the commands and guard rail that keep seeding/reset safe and idempotent. See [06-local-development.md](../../../docs/06-local-development.md) and [03-data-model.md](../../../docs/03-data-model.md) for the target document shapes this data follows.
